...
def main():
    ...
    chrome_options.add_argument("--enable-webgl")  # Включаем WebGL
    chrome_options.add_argument("--use-gl=default")  # Включаем стандартный OpenGL
    chrome_options.add_argument("--disable-accelerated-2d-canvas")  # Отключаем ускоренный 2D-рендеринг
